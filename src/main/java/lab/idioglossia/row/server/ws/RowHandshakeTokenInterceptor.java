...
import static lab.idioglossia.row.server.config.Naming.EXTRA_ATTRIBUTE_NAME;
import static lab.idioglossia.row.server.config.Naming.USER_ID_ATTRIBUTE_NAME;
